...
namespace Scripts.World
{
    public class CameraFade : MonoBehaviour
    {
        ...
        public bool m_UndoWhenFinished = false;
            ...
            if (Time.time > instance.m_FadeDelay)
            {
                ...
                if (instance.m_CurrentScreenOverlayColor != instance.m_TargetScreenOverlayColor)
                {
                    ...
                    if (Mathf.Abs(instance.m_CurrentScreenOverlayColor.a - instance.m_TargetScreenOverlayColor.a) < Mathf.Abs(instance.m_DeltaColor.a) * Time.deltaTime)
                    {
                        ...
                        if (instance.m_UndoWhenFinished)
                        {
                            instance.m_UndoWhenFinished = false;
                            instance.m_OnFadeFinish = null;
                            instance.m_TargetScreenOverlayColor = new Color(instance.m_TargetScreenOverlayColor.r, 
                                    instance.m_TargetScreenOverlayColor.g, instance.m_TargetScreenOverlayColor.b, 0);
                            instance.m_DeltaColor = (instance.m_TargetScreenOverlayColor - instance.m_CurrentScreenOverlayColor) / m_FadeDuration;
                        }
                        else
                        {
                            Die();
        ...
        /// Fade delay.
        /// </param>
        /// <param name='undoWhenFinished'>
        /// On fade finish, undo the fade.
        /// </param>
        public static void StartAlphaFade(Color newScreenOverlayColor, bool isFadeIn, float fadeDuration, float fadeDelay, bool undoWhenFinished)
        {
            if (fadeDuration <= 0.0f)
            {
                SetScreenOverlayColor(newScreenOverlayColor);
            ...
            else
            {
                ...
                instance.m_FadeDelay = Time.time + fadeDelay;
                instance.m_UndoWhenFinished = undoWhenFinished;
                if (isFadeIn)
                {
                    instance.m_TargetScreenOverlayColor = new Color(newScreenOverlayColor.r, newScreenOverlayColor.g, newScreenOverlayColor.b, 0);
                    SetScreenOverlayColor(newScreenOverlayColor);
        ...
        /// On fade finish, undo the fade.
        /// </param>
        public static void StartAlphaFade(Color newScreenOverlayColor, bool isFadeIn, float fadeDuration, float fadeDelay, Action OnFadeFinish, bool undoWhenFinished)
        {
            if (fadeDuration <= 0.0f)
            {
                SetScreenOverlayColor(newScreenOverlayColor);
